...
item(cassava_seed, 3, 120, 1, 0, 0).
item(corn_seed, 4, 140, 2, 0, 0).
item(tomato_seed, 5, 130, 3, 0, 0).
item(potato_seed, 6, 150, 4, 0, 0).
/* Equipment */
item(shovel, 1, 250, 3, 0, 0).
item(hand_fork, 2, 150, 1, 0, 0).
...
item(grade_c_food, 9, 100, 0, 1, 0).
/* Equipment */
item(fishnet, 4, 250, 0, 3, 0).
